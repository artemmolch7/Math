...
public class MSEGraphic extends ApplicationFrame {
    public MSEGraphic(String title, int methodNumber) {
        super(title);
    ...
    private DefaultCategoryDataset createDataset(int methodNumber) {
        ...
        for (int n = 1; n <= 100; n++) {
            ...
            double mae = (actualValue - integralSumValue)*(actualValue - integralSumValue);
            dataset.addValue(mae, "MSE", Integer.toString(n));
        }
        return dataset;
    }
}
